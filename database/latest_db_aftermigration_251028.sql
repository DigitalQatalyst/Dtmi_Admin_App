...
COMMENT ON SCHEMA "public" IS 'Ecosystem database with prefixed table names for better organization';
...
COMMENT ON FUNCTION "public"."get_app_customer_type"() IS 'Returns the current user customer type from app context or database lookup';
...
COMMENT ON FUNCTION "public"."get_app_organization_id"() IS 'Returns the current user organization ID from app context or database lookup';
...
COMMENT ON FUNCTION "public"."get_app_user_role"() IS 'Returns the current user role from app context or database lookup';
...
COMMENT ON FUNCTION "public"."get_current_customer_type"() IS 'Extracts customer type from JWT token for RLS policies';
...
COMMENT ON FUNCTION "public"."get_current_organisation_id"() IS 'Extracts organization ID from JWT token for RLS policies';
...
COMMENT ON FUNCTION "public"."get_current_user_org_id"() IS 'Returns current user organization ID from app settings';
...
COMMENT ON FUNCTION "public"."get_current_user_role"() IS 'Returns current user role from app settings';
...
COMMENT ON FUNCTION "public"."is_enterprise_user"() IS 'Checks if current user is enterprise type';
...
COMMENT ON FUNCTION "public"."is_partner_user"() IS 'Checks if current user is partner type';
...
COMMENT ON FUNCTION "public"."is_staff_user"() IS 'Checks if current user is staff type';
...
COMMENT ON FUNCTION "public"."is_staff_with_allowed_org"() IS 'Checks if current user is staff with allowed organization';
...
CREATE TABLE IF NOT EXISTS "public"."auth_user_profiles" (
    ...
    "customer_type" "text" DEFAULT 'enterprise'::"text",
    "profile_data" "jsonb" DEFAULT '{}'::"jsonb",
    "preferences" "jsonb" DEFAULT '{}'::"jsonb",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "customer_type_check" CHECK (("customer_type" = ANY (ARRAY['staff'::"text", 'partner'::"text", 'enterprise'::"text", 'advisor'::"text"]))),
    CONSTRAINT "role_check" CHECK (("role" = ANY (ARRAY['admin'::"text", 'approver'::"text", 'creator'::"text", 'contributor'::"text", 'viewer'::"text"])))
);

ALTER TABLE ONLY "public"."auth_user_profiles" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."auth_user_profiles" OWNER TO "postgres";


COMMENT ON COLUMN "public"."auth_user_profiles"."role" IS 'User role: admin, approver, creator, contributor, or viewer';



COMMENT ON COLUMN "public"."auth_user_profiles"."customer_type" IS 'Customer type: staff, partner, enterprise, or advisor';
...
COMMENT ON COLUMN "public"."auth_users"."azure_sub" IS 'Azure AD Subject (sub claim) - app-specific, varies per registration. Kept for legacy compatibility only. Use azure_oid for lookups.';



COMMENT ON COLUMN "public"."auth_users"."azure_oid" IS 'Azure AD Object ID (oid claim) - PRIMARY federated identifier. Stable across all app registrations. Use for all user lookups.';
...
ALTER TABLE ONLY "public"."cnt_contents" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."cnt_contents" OWNER TO "postgres";


COMMENT ON TABLE "public"."cnt_contents" IS 'Content articles, insights, success stories, and news';
...
COMMENT ON TABLE "public"."cnt_events" IS 'Content events, workshops, and conferences';
...
COMMENT ON TABLE "public"."cnt_experiences" IS 'Content tourism and cultural experiences';
...
COMMENT ON TABLE "public"."cnt_metrics" IS 'Content metrics: economic indicators and impact statistics';
...
ALTER TABLE ONLY "public"."cnt_resources" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."cnt_resources" OWNER TO "postgres";


COMMENT ON TABLE "public"."cnt_resources" IS 'Content educational resources, tools, and templates';
...
ALTER TABLE ONLY "public"."comm_mentors" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."comm_mentors" OWNER TO "postgres";


COMMENT ON TABLE "public"."comm_mentors" IS 'Community mentor profiles and information';
...
CREATE TABLE IF NOT EXISTS "public"."wf_review_actions" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "created_by" "uuid",
    CONSTRAINT "review_approval_actions_action_type_check" CHECK ((("action_type")::"text" = ANY ((ARRAY['Submit'::character varying, 'Approve'::character varying, 'Reject'::character varying, 'Send Back'::character varying, 'Publish'::character varying, 'Unpublish'::character varying, 'Archive'::character varying, 'Restore'::character varying, 'Flag for Review'::character varying])::"text"[])))
);
...
COMMENT ON TABLE "public"."wf_review_actions" IS 'Records each approval/rejection action within a workflow.';
...
CREATE TABLE IF NOT EXISTS "public"."wf_review_comments" (
    ...
    "created_by" "uuid",
    "updated_by" "uuid",
    CONSTRAINT "review_comments_comment_type_check" CHECK ((("comment_type")::"text" = ANY ((ARRAY['Review'::character varying, 'Approval'::character varying, 'Rejection'::character varying, 'General'::character varying, 'System'::character varying])::"text"[])))
);
...
COMMENT ON TABLE "public"."wf_review_comments" IS 'Stores reviewer comments and threaded feedback.';
...
CREATE TABLE IF NOT EXISTS "public"."wf_review_cycles" (
    ...
    "created_by" "uuid",
    "updated_by" "uuid",
    CONSTRAINT "content_review_cycles_priority_check" CHECK ((("priority")::"text" = ANY ((ARRAY['Low'::character varying, 'Normal'::character varying, 'High'::character varying, 'Urgent'::character varying])::"text"[]))),
    CONSTRAINT "content_review_cycles_status_check" CHECK ((("status")::"text" = ANY ((ARRAY['Draft'::character varying, 'Pending Review'::character varying, 'Under Review'::character varying, 'Approved'::character varying, 'Rejected'::character varying, 'Sent Back'::character varying, 'Published'::character varying, 'Unpublished'::character varying, 'Archived'::character varying])::"text"[])))
);
...
COMMENT ON TABLE "public"."wf_review_cycles" IS 'Tracks review cycles for content approval and publication.';
...
COMMENT ON TABLE "public"."dim_business_stages" IS 'Business maturity stages: ideation, mvp, early-stage, growth, scale-up';
...
COMMENT ON TABLE "public"."dim_program_types" IS 'Program types: accelerator, incubator, mentorship, funding, training';
...
COMMENT ON TABLE "public"."dim_sectors" IS 'Industry sectors: technology, fintech, manufacturing, etc. (hierarchical)';
...
COMMENT ON TABLE "public"."dim_support_categories" IS 'Support categories: women-entrepreneur, emirati-support, startup-funding, etc.';
...
ALTER TABLE ONLY "public"."eco_business_directory" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."eco_business_directory" OWNER TO "postgres";


COMMENT ON TABLE "public"."eco_business_directory" IS 'Ecosystem organizations: businesses, support entities, associations, etc.';
...
ALTER TABLE ONLY "public"."eco_growth_areas" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."eco_growth_areas" OWNER TO "postgres";


COMMENT ON TABLE "public"."eco_growth_areas" IS 'Ecosystem growth areas with analytics and projections';
...
ALTER TABLE ONLY "public"."eco_programs" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."eco_programs" OWNER TO "postgres";


COMMENT ON TABLE "public"."eco_programs" IS 'Ecosystem support programs and initiatives';
...
ALTER TABLE ONLY "public"."eco_zones" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."eco_zones" OWNER TO "postgres";


COMMENT ON TABLE "public"."eco_zones" IS 'Ecosystem locations: economic zones, offices, attractions, etc.';
...
COMMENT ON TABLE "public"."geo_emirates" IS 'Geographic emirate information and boundaries';
...
COMMENT ON TABLE "public"."jct_investment_sectors" IS 'Junction table mapping investment opportunities to sectors.';
...
COMMENT ON TABLE "public"."mktplc_investment_opportunities" IS 'Marketplace investment opportunities and projects';
...
ALTER TABLE ONLY "public"."mktplc_services" FORCE ROW LEVEL SECURITY;


ALTER TABLE "public"."mktplc_services" OWNER TO "postgres";


COMMENT ON TABLE "public"."mktplc_services" IS 'Marketplace service offerings';
...
CREATE TABLE IF NOT EXISTS "public"."wf_review_assignments" (
    ...
    "created_by" "uuid",
    "updated_by" "uuid",
    CONSTRAINT "review_assignments_assignment_type_check" CHECK ((("assignment_type")::"text" = ANY ((ARRAY['Primary'::character varying, 'Secondary'::character varying, 'Backup'::character varying])::"text"[]))),
    CONSTRAINT "review_assignments_status_check" CHECK ((("status")::"text" = ANY ((ARRAY['Assigned'::character varying, 'Accepted'::character varying, 'In Progress'::character varying, 'Completed'::character varying, 'Declined'::character varying, 'Reassigned'::character varying])::"text"[])))
);
...
COMMENT ON TABLE "public"."wf_review_assignments" IS 'Maps reviewers to workflow steps.';
...
COMMENT ON TABLE "public"."wf_review_templates" IS 'Defines reusable templates for workflow configurations.';
...
CREATE POLICY "Public read" ON "public"."cnt_contents" FOR SELECT USING (true);
...
CREATE POLICY "Users can view content in their org" ON "public"."cnt_contents" FOR SELECT USING (("organization_id" IN ( SELECT "auth_user_profiles"."organization_id"
   FROM "public"."auth_user_profiles"
  WHERE ("auth_user_profiles"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can view their own profile" ON "public"."auth_user_profiles" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR ("organization_id" IN ( SELECT "auth_user_profiles_1"."organization_id"
   FROM "public"."auth_user_profiles" "auth_user_profiles_1"
  WHERE ("auth_user_profiles_1"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "admin_override" ON "public"."cnt_contents" USING (("current_setting"('request.jwt.claim.role'::"text", true) = 'service_role'::"text")) WITH CHECK (true);
...
COMMENT ON POLICY "business_directory_insert_policy" ON "public"."eco_business_directory" IS 'RLS policy for business directory table inserts - organization scoped';
...
COMMENT ON POLICY "contents_delete_policy" ON "public"."cnt_contents" IS 'RLS policy for contents table deletes - staff only';
...
COMMENT ON POLICY "contents_insert_policy" ON "public"."cnt_contents" IS 'RLS policy for contents table inserts - organization scoped';



CREATE POLICY "contents_select_policy" ON "public"."cnt_contents" USING (
CASE
    WHEN "public"."is_staff_user"() THEN true
...
COMMENT ON POLICY "growth_areas_delete_policy" ON "public"."eco_growth_areas" IS 'RLS policy for growth areas table deletes - staff only';
...
COMMENT ON POLICY "growth_areas_insert_policy" ON "public"."eco_growth_areas" IS 'RLS policy for growth areas table inserts - organization scoped';
...
CREATE POLICY "org_read" ON "public"."cnt_contents" USING (("organization_id" = "public"."get_org_id_from_claim"())) WITH CHECK (("organization_id" = "public"."get_org_id_from_claim"()));
...
CREATE POLICY "org_rls_policy" ON "public"."cnt_contents" USING (("organization_id" = "public"."get_app_organization_id"())) WITH CHECK (("organization_id" = "public"."get_app_organization_id"()));
...
COMMENT ON POLICY "services_delete_policy" ON "public"."mktplc_services" IS 'RLS policy for services table deletes - staff only';
...
COMMENT ON POLICY "services_insert_policy" ON "public"."mktplc_services" IS 'RLS policy for services table inserts - organization scoped';
...
GRANT SELECT ON TABLE "public"."activity_logs" TO "test_user";
...
GRANT SELECT ON TABLE "public"."auth_organization_members" TO "test_user";
...
GRANT SELECT ON TABLE "public"."auth_organizations" TO "test_user";
...
GRANT SELECT ON TABLE "public"."auth_user_profiles" TO "test_user";
...
GRANT SELECT ON TABLE "public"."auth_users" TO "test_user";
...
GRANT SELECT ON TABLE "public"."cnt_events" TO "test_user";
...
GRANT SELECT ON TABLE "public"."cnt_experiences" TO "test_user";
...
GRANT SELECT ON TABLE "public"."cnt_metrics" TO "test_user";
...
GRANT SELECT ON TABLE "public"."wf_review_actions" TO "test_user";
...
GRANT SELECT ON TABLE "public"."wf_review_comments" TO "test_user";
...
GRANT SELECT ON TABLE "public"."wf_review_cycles" TO "test_user";
...
GRANT SELECT ON TABLE "public"."content_review_status" TO "test_user";
...
GRANT SELECT ON TABLE "public"."dim_business_stages" TO "test_user";
...
GRANT SELECT ON TABLE "public"."dim_program_types" TO "test_user";
...
GRANT SELECT ON TABLE "public"."dim_sectors" TO "test_user";
...
GRANT SELECT ON TABLE "public"."dim_support_categories" TO "test_user";
...
GRANT SELECT ON TABLE "public"."eco_business_directory" TO "test_user";
...
GRANT SELECT ON TABLE "public"."eco_growth_areas" TO "test_user";
...
GRANT SELECT ON TABLE "public"."eco_programs" TO "test_user";
...
GRANT SELECT ON TABLE "public"."eco_zones" TO "test_user";
...
GRANT SELECT ON TABLE "public"."geo_emirates" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_business_sectors" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_business_support_categories" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_content_sectors" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_event_sectors" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_event_support_categories" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_investment_sectors" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_program_support_categories" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_program_target_stages" TO "test_user";
...
GRANT SELECT ON TABLE "public"."jct_resource_sectors" TO "test_user";
...
GRANT SELECT ON TABLE "public"."mktplc_investment_opportunities" TO "test_user";
...
GRANT SELECT ON TABLE "public"."mktplc_services" TO "test_user";
...
GRANT SELECT ON TABLE "public"."v_cnt_active_events" TO "test_user";
...
GRANT SELECT ON TABLE "public"."v_cnt_metrics_latest" TO "test_user";
...
GRANT SELECT ON TABLE "public"."wf_review_assignments" TO "test_user";
...
GRANT SELECT ON TABLE "public"."wf_review_templates" TO "test_user";
