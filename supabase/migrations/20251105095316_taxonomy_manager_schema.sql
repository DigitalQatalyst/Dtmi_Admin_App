...
CREATE INDEX "idx_txn_tags_value" ON "public"."txn_tags" USING "btree" ("value");



CREATE INDEX "idx_txn_facets_code" ON "public"."txn_facets" USING "btree" ("code");



CREATE INDEX "idx_txn_facet_translations_base_id" ON "public"."txn_facet_translations" USING "btree" ("base_id");



CREATE INDEX "idx_txn_facet_translations_language_code" ON "public"."txn_facet_translations" USING "btree" ("language_code");



CREATE INDEX "idx_txn_facet_values_facet_id" ON "public"."txn_facet_values" USING "btree" ("facet_id");



CREATE INDEX "idx_txn_facet_values_code" ON "public"."txn_facet_values" USING "btree" ("code");



CREATE INDEX "idx_txn_facet_value_translations_base_id" ON "public"."txn_facet_value_translations" USING "btree" ("base_id");



CREATE INDEX "idx_txn_facet_value_translations_language_code" ON "public"."txn_facet_value_translations" USING "btree" ("language_code");



CREATE INDEX "idx_txn_collections_parent_id" ON "public"."txn_collections" USING "btree" ("parent_id");



CREATE INDEX "idx_txn_collections_position" ON "public"."txn_collections" USING "btree" ("position");



CREATE INDEX "idx_txn_collection_translations_base_id" ON "public"."txn_collection_translations" USING "btree" ("base_id");



CREATE INDEX "idx_txn_collection_translations_language_code" ON "public"."txn_collection_translations" USING "btree" ("language_code");



CREATE INDEX "idx_txn_collection_translations_slug" ON "public"."txn_collection_translations" USING "btree" ("slug");
