...
CREATE OR REPLACE FUNCTION "public"."_is_authenticated"() RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."_is_authenticated"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."_is_public_published"("_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."_is_public_published"("_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."_jtxt"("j" "jsonb", "key" "text") RETURNS "text"
    LANGUAGE "sql" IMMUTABLE
    AS $$ SELECT NULLIF(j->>key,'') $$;


ALTER FUNCTION "public"."_jtxt"("j" "jsonb", "key" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_access_organisation"("org_id" "uuid") RETURNS boolean
...
ALTER FUNCTION "public"."can_access_organisation"("org_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_media_item"("_base" "jsonb", "_type" "text", "_child" "jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "public"."create_media_item"("_base" "jsonb", "_type" "text", "_child" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."current_org_id_from_name"() RETURNS "uuid"
...
ALTER FUNCTION "public"."current_org_id_from_name"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."effective_org_id"() RETURNS "uuid"
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."effective_org_id"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."enforce_slug_normalization"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."enforce_slug_normalization"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_app_customer_type"() RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_app_customer_type"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_app_organization_id"() RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_app_organization_id"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_claim_org_id"() RETURNS "uuid"
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."get_claim_org_id"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_claim_org_name"() RETURNS "text"
    LANGUAGE "sql" STABLE
    AS $$
...
ALTER FUNCTION "public"."get_claim_org_name"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_current_customer_type"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_current_organisation_id"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_current_user_context"() RETURNS TABLE("user_id" "text", "customer_type" "text", "user_role" "text", "organisation_name" "text", "organisation_id" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY SELECT
...
CREATE OR REPLACE FUNCTION "public"."get_current_user_organisation"() RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  user_org_id UUID;
...
ALTER FUNCTION "public"."get_current_user_organisation"() OWNER TO "postgres";
...
ALTER TABLE "public"."media_taxonomies" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."v_media_all" AS
 SELECT "m"."id",
    "m"."slug",
    COALESCE("m"."title", ("to_jsonb"("m".*) ->> 'title'::"text")) AS "title",
    COALESCE("m"."summary", ("to_jsonb"("m".*) ->> 'summary'::"text")) AS "summary",
    "m"."status",
    "m"."visibility",
    "m"."language",
    "m"."seo_title",
    ...
    "m"."thumbnail_url",
    "m"."tags",
    COALESCE(("to_jsonb"("m".*) ->> 'type'::"text"),
        CASE
            WHEN ("a"."id" IS NOT NULL) THEN 'Article'::"text"
            WHEN ("v"."id" IS NOT NULL) THEN 'Video'::"text"
            WHEN ("p"."id" IS NOT NULL) THEN 'Podcast'::"text"
            WHEN ("r"."id" IS NOT NULL) THEN 'Report'::"text"
            WHEN ("t"."id" IS NOT NULL) THEN 'Tool'::"text"
            WHEN ("e"."id" IS NOT NULL) THEN 'Event'::"text"
            ELSE NULL::"text"
        END) AS "type",
    ...
    "a"."announcement_date" AS "article_announcement_date",
    "a"."document_url" AS "article_document_url",
    COALESCE("a"."body_html", ("to_jsonb"("m".*) ->> 'body'::"text"), ("to_jsonb"("m".*) ->> 'body_html'::"text")) AS "body_html",
    COALESCE("a"."body_json", ("to_jsonb"("m".*) -> 'body_json'::"text")) AS "body_json",
    "v"."video_url",
    "v"."platform",
    ...
    "r"."highlights" AS "report_highlights",
    "r"."toc" AS "report_toc",
    ...
    COALESCE("e"."agenda", ("to_jsonb"("m".*) -> 'event_agenda'::"text")) AS "event_agenda",
    COALESCE(("to_jsonb"("m".*) ->> 'domain'::"text"), ( SELECT "t1"."label"
           FROM ("public"."media_taxonomies" "mt"
             JOIN "public"."taxonomies" "t1" ON (("t1"."id" = "mt"."taxonomy_id")))
          WHERE (("mt"."media_id" = "m"."id") AND ("t1"."kind" = 'Domain'::"text"))
          ORDER BY "t1"."position", "t1"."label"
         LIMIT 1)) AS "domain",
    ("to_jsonb"("m".*) -> 'authors'::"text") AS "authors",
    ("to_jsonb"("m".*) -> 'author_slugs'::"text") AS "author_slugs"
...
ALTER VIEW "public"."v_media_all" OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_media_item_full"("media_id" "uuid") RETURNS "public"."v_media_all"
    LANGUAGE "sql" STABLE
    AS $$ SELECT * FROM public.v_media_all WHERE id=media_id $$;


ALTER FUNCTION "public"."get_media_item_full"("media_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_org_id_from_claim"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."increment_flag_count"("content_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  UPDATE cnt_contents
...
ALTER FUNCTION "public"."increment_flag_count"("content_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_enterprise_user"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."is_enterprise_user"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_member_of_claim_org"() RETURNS boolean
    LANGUAGE "sql" STABLE
    AS $$
  SELECT EXISTS (
...
ALTER FUNCTION "public"."is_member_of_claim_org"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."is_partner_user"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_staff_with_allowed_org"() RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    customer_type TEXT;
...
ALTER FUNCTION "public"."is_staff_with_allowed_org"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."log_activity"("p_entity_type" "text", "p_entity_id" "uuid", "p_action" "text", "p_details" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_user_id UUID;
...
ALTER FUNCTION "public"."log_activity"("p_entity_type" "text", "p_entity_id" "uuid", "p_action" "text", "p_details" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."set_current_user_context"("user_id" "text", "customer_type" "text", "user_role" "text", "organisation_name" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_current_user_context"("user_id" "text", "customer_type" "text", "user_role" "text", "organisation_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_org_and_creator"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_org_and_creator"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."test_rls_visibility"() RETURNS TABLE("claim" "text", "table_name" "text", "visible_count" integer, "total_rows" integer)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    claim_ text;
...
ALTER FUNCTION "public"."test_rls_visibility"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."test_rls_visibility"("org_claim" "text") RETURNS TABLE("claim" "text", "table_name" "text", "visible_count" integer, "total_rows" integer, "visible_orgs" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  tbl text;
...
ALTER FUNCTION "public"."test_rls_visibility"("org_claim" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_media_item"("_id" "uuid", "_base" "jsonb", "_type" "text", "_child" "jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "public"."update_media_item"("_id" "uuid", "_base" "jsonb", "_type" "text", "_child" "jsonb") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."auth_organization_members" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."auth_organization_members" OWNER TO "postgres";
...
ALTER TABLE "public"."auth_organizations" OWNER TO "postgres";
...
ALTER TABLE "public"."cnt_contents" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."cnt_events" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "title" "text" NOT NULL,
    "slug" "text",
    "event_type" "text",
...
ALTER TABLE "public"."cnt_events" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."cnt_experiences" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "title" "text" NOT NULL,
    "slug" "text",
    "description" "text",
...
ALTER TABLE "public"."cnt_experiences" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."cnt_metrics" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."cnt_metrics" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."cnt_resources" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "title" "text" NOT NULL,
    "slug" "text",
    "resource_type" "text",
...
ALTER TABLE "public"."cnt_resources" OWNER TO "postgres";
...
ALTER TABLE "public"."comm_mentors" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."wf_review_actions" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."wf_review_actions" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."wf_review_comments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "review_cycle_id" "uuid" NOT NULL,
    "content_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."wf_review_comments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."wf_review_cycles" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "content_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."wf_review_cycles" OWNER TO "postgres";


DROP VIEW IF EXISTS "public"."content_review_status" CASCADE;


CREATE OR REPLACE VIEW "public"."content_review_status" AS
...
ALTER VIEW "public"."content_review_status" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dim_business_stages" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."dim_business_stages" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dim_program_types" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."dim_program_types" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dim_sectors" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."dim_sectors" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dim_support_categories" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."dim_support_categories" OWNER TO "postgres";
...
ALTER TABLE "public"."eco_business_directory" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."eco_growth_areas" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "name" "text" NOT NULL,
    "zone_id" "uuid",
    "description" "text",
...
ALTER TABLE "public"."eco_growth_areas" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."eco_programs" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."eco_programs" OWNER TO "postgres";
...
ALTER TABLE "public"."eco_zones" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."geo_emirates" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."geo_emirates" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_business_sectors" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."jct_business_sectors" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_business_support_categories" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "business_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."jct_business_support_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_content_sectors" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "content_id" "uuid" NOT NULL,
    "sector_id" "uuid" NOT NULL,
    "is_primary" boolean DEFAULT false,
...
ALTER TABLE "public"."jct_content_sectors" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_event_sectors" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."jct_event_sectors" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_event_support_categories" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "event_id" "uuid" NOT NULL,
    "support_category_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"()
...
ALTER TABLE "public"."jct_event_support_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_investment_sectors" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."jct_investment_sectors" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_program_support_categories" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."jct_program_support_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_program_target_stages" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "program_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."jct_program_target_stages" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."jct_resource_sectors" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "public"."jct_resource_sectors" OWNER TO "postgres";
...
ALTER TABLE "public"."media_views" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."mktplc_investment_opportunities" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "title" "text" NOT NULL,
    "slug" "text",
    "sector" "text",
...
ALTER TABLE "public"."mktplc_investment_opportunities" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."mktplc_services" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "title" "text" NOT NULL,
    ...
    "provider_id" "uuid",
    "tags" "text"[] DEFAULT '{}'::"text"[],
    CONSTRAINT "services_status_check" CHECK (("status" = ANY (ARRAY['Draft'::"text", 'Pending'::"text", 'Published'::"text", 'Rejected'::"text", 'Sent Back'::"text", 'Step 2 Pending'::"text", 'Step 3 Pending'::"text", 'Step 4 Pending'::"text"]))),
    CONSTRAINT "services_type_check" CHECK (("type" = ANY (ARRAY['Financial'::"text", 'Non-Financial'::"text"])))
);


ALTER TABLE "public"."mktplc_services" OWNER TO "postgres";


DROP VIEW IF EXISTS "public"."v_cnt_active_events" CASCADE;


CREATE OR REPLACE VIEW "public"."v_cnt_active_events" AS
 SELECT "id",
    "title",
    "slug",
    "event_type",
...
ALTER VIEW "public"."v_cnt_active_events" OWNER TO "postgres";


DROP VIEW IF EXISTS "public"."v_cnt_metrics_latest" CASCADE;


CREATE OR REPLACE VIEW "public"."v_cnt_metrics_latest" AS
...
ALTER VIEW "public"."v_cnt_metrics_latest" OWNER TO "postgres";
...
ALTER VIEW "public"."v_media_public" OWNER TO "postgres";


DROP VIEW IF EXISTS "public"."v_media_public_grid" CASCADE;
...
ALTER VIEW "public"."v_media_public_grid" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."wf_review_assignments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "review_cycle_id" "uuid" NOT NULL,
    "content_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."wf_review_assignments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."wf_review_templates" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."wf_review_templates" OWNER TO "postgres";


--
-- Taxonomy Manager Tables
--
...
ALTER TABLE "public"."txn_tags" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."txn_facets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."txn_facets" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."txn_facet_translations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."txn_facet_translations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."txn_facet_values" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "code" character varying(255) NOT NULL,
...
ALTER TABLE "public"."txn_facet_values" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."txn_facet_value_translations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "language_code" character varying(10) NOT NULL,
...
ALTER TABLE "public"."txn_facet_value_translations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."txn_collections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."txn_collections" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."txn_collection_translations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "language_code" character varying(10) NOT NULL,
...
ALTER TABLE "public"."txn_collection_translations" OWNER TO "postgres";
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'auth_organization_members_pkey' 
        AND conrelid = 'public.auth_organization_members'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'auth_organizations_pkey' 
        AND conrelid = 'public.auth_organizations'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'auth_user_profiles_pkey' 
        AND conrelid = 'public.auth_user_profiles'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'business_directory_pkey' 
        AND conrelid = 'public.eco_business_directory'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'business_sectors_pkey' 
        AND conrelid = 'public.jct_business_sectors'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."jct_business_sectors"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'business_support_categories_pkey' 
        AND conrelid = 'public.jct_business_support_categories'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."jct_business_support_categories"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'content_review_cycles_pkey' 
        AND conrelid = 'public.wf_review_cycles'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'content_sectors_pkey' 
        AND conrelid = 'public.jct_content_sectors'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."jct_content_sectors"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'dim_business_stages_pkey' 
        AND conrelid = 'public.dim_business_stages'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'dim_program_types_pkey' 
        AND conrelid = 'public.dim_program_types'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'dim_sectors_pkey' 
        AND conrelid = 'public.dim_sectors'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'dim_support_categories_pkey' 
        AND conrelid = 'public.dim_support_categories'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."dim_support_categories"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'emirates_pkey' 
        AND conrelid = 'public.geo_emirates'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."geo_emirates"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'event_sectors_pkey' 
        AND conrelid = 'public.jct_event_sectors'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."jct_event_sectors"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'event_support_categories_pkey' 
        AND conrelid = 'public.jct_event_support_categories'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."jct_event_support_categories"
...
BEGIN
    IF NOT EXISTS (
        ...
        AND conrelid = 'public.cnt_events'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'experiences_pkey' 
        AND conrelid = 'public.cnt_experiences'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'growth_areas_pkey' 
        AND conrelid = 'public.eco_growth_areas'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'investment_opportunities_pkey' 
        AND conrelid = 'public.mktplc_investment_opportunities'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'investment_sectors_pkey' 
        AND conrelid = 'public.jct_investment_sectors'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."jct_investment_sectors"
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'media_assets_pkey' 
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'media_items_pkey' 
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'media_taxonomies_pkey' 
        AND conrelid = 'public.media_taxonomies'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'media_views_pkey' 
        AND conrelid = 'public.media_views'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'mentors_pkey' 
        AND conrelid = 'public.comm_mentors'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND conrelid = 'public.cnt_metrics'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'program_support_categories_pkey' 
        AND conrelid = 'public.jct_program_support_categories'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'program_target_stages_pkey' 
        AND conrelid = 'public.jct_program_target_stages'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND conrelid = 'public.eco_programs'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'resource_sectors_pkey' 
        AND conrelid = 'public.jct_resource_sectors'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND conrelid = 'public.cnt_resources'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'review_approval_actions_pkey' 
        AND conrelid = 'public.wf_review_actions'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'review_assignments_pkey' 
        AND conrelid = 'public.wf_review_assignments'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND conrelid = 'public.wf_review_comments'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'review_workflow_templates_pkey' 
        AND conrelid = 'public.wf_review_templates'::regclass
    ) THEN
...
ALTER TABLE ONLY "public"."txn_tags"
    ADD CONSTRAINT "txn_tags_value_key" UNIQUE ("value");
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'txn_facets_pkey' 
        AND conrelid = 'public.txn_facets'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."txn_facets"
            ADD CONSTRAINT "txn_facets_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
ALTER TABLE ONLY "public"."txn_facets"
    ADD CONSTRAINT "txn_facets_code_key" UNIQUE ("code");
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'txn_facet_translations_pkey' 
        AND conrelid = 'public.txn_facet_translations'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."txn_facet_translations"
            ADD CONSTRAINT "txn_facet_translations_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE ONLY "public"."txn_facet_values"
            ADD CONSTRAINT "txn_facet_values_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
ALTER TABLE ONLY "public"."txn_facet_values"
    ADD CONSTRAINT "txn_facet_values_code_key" UNIQUE ("code");
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'txn_facet_value_translations_pkey' 
        AND conrelid = 'public.txn_facet_value_translations'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."txn_facet_value_translations"
            ADD CONSTRAINT "txn_facet_value_translations_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE ONLY "public"."txn_collections"
            ADD CONSTRAINT "txn_collections_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'txn_collection_translations_pkey' 
        AND conrelid = 'public.txn_collection_translations'::regclass
    ) THEN
        ALTER TABLE ONLY "public"."txn_collection_translations"
            ADD CONSTRAINT "txn_collection_translations_pkey" PRIMARY KEY ("id");
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        AND conrelid = 'public.mktplc_services'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'taxonomies_pkey' 
        AND conrelid = 'public.taxonomies'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint 
        WHERE conname = 'zones_pkey' 
        AND conrelid = 'public.eco_zones'::regclass
    ) THEN
...
CREATE INDEX IF NOT EXISTS "idx_activity_logs_entity_type" ON "public"."activity_logs" USING "btree" ("entity_type");



CREATE INDEX IF NOT EXISTS "idx_activity_logs_organisation_id" ON "public"."activity_logs" USING "btree" ("organization_id");
...
CREATE INDEX IF NOT EXISTS "idx_aom_org" ON "public"."auth_organization_members" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_aom_roles_gin" ON "public"."auth_organization_members" USING "gin" ("roles");



CREATE INDEX IF NOT EXISTS "idx_aom_user" ON "public"."auth_organization_members" USING "btree" ("user_id");



CREATE INDEX IF NOT EXISTS "idx_auth_user_profiles_role" ON "public"."auth_user_profiles" USING "btree" ("role");



CREATE INDEX IF NOT EXISTS "idx_auth_user_profiles_segment_role" ON "public"."auth_user_profiles" USING "btree" ("user_segment", "role");



CREATE INDEX IF NOT EXISTS "idx_auth_user_profiles_user_segment" ON "public"."auth_user_profiles" USING "btree" ("user_segment");



CREATE UNIQUE INDEX IF NOT EXISTS "idx_auth_users_azure_oid" ON "public"."auth_users" USING "btree" ("azure_oid") WHERE ("azure_oid" IS NOT NULL);



CREATE UNIQUE INDEX IF NOT EXISTS "idx_auth_users_azure_sub" ON "public"."auth_users" USING "btree" ("azure_sub") WHERE ("azure_sub" IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS "idx_bus_sectors_business" ON "public"."jct_business_sectors" USING "btree" ("business_id");



CREATE INDEX IF NOT EXISTS "idx_bus_sectors_sector" ON "public"."jct_business_sectors" USING "btree" ("sector_id");



CREATE INDEX IF NOT EXISTS "idx_bus_support_business" ON "public"."jct_business_support_categories" USING "btree" ("business_id");



CREATE INDEX IF NOT EXISTS "idx_bus_support_category" ON "public"."jct_business_support_categories" USING "btree" ("support_category_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_featured" ON "public"."cnt_contents" USING "btree" ("is_featured");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_flag_count" ON "public"."cnt_contents" USING "btree" ("flag_count");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_flagged_at" ON "public"."cnt_contents" USING "btree" ("flagged_at");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_organisation_id" ON "public"."cnt_contents" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_published" ON "public"."cnt_contents" USING "btree" ("published_at");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_sector" ON "public"."cnt_contents" USING "btree" ("primary_sector_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_subtype" ON "public"."cnt_contents" USING "btree" ("content_subtype");



CREATE INDEX IF NOT EXISTS "idx_cnt_contents_type" ON "public"."cnt_contents" USING "btree" ("content_type");



CREATE INDEX IF NOT EXISTS "idx_cnt_events_date" ON "public"."cnt_events" USING "btree" ("date");



CREATE INDEX IF NOT EXISTS "idx_cnt_events_location" ON "public"."cnt_events" USING "btree" ("location_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_events_org" ON "public"."cnt_events" USING "btree" ("organizer_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_events_sector" ON "public"."cnt_events" USING "btree" ("primary_sector_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_metrics_category" ON "public"."cnt_metrics" USING "btree" ("category");



CREATE INDEX IF NOT EXISTS "idx_cnt_metrics_code" ON "public"."cnt_metrics" USING "btree" ("metric_code");



CREATE INDEX IF NOT EXISTS "idx_cnt_metrics_date" ON "public"."cnt_metrics" USING "btree" ("date");



CREATE INDEX IF NOT EXISTS "idx_cnt_metrics_featured" ON "public"."cnt_metrics" USING "btree" ("is_featured");



CREATE INDEX IF NOT EXISTS "idx_cnt_metrics_type" ON "public"."cnt_metrics" USING "btree" ("metric_type");



CREATE INDEX IF NOT EXISTS "idx_cnt_metrics_year_quarter" ON "public"."cnt_metrics" USING "btree" ("year", "quarter");



CREATE INDEX IF NOT EXISTS "idx_cnt_resources_org" ON "public"."cnt_resources" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_resources_sector" ON "public"."cnt_resources" USING "btree" ("primary_sector_id");



CREATE INDEX IF NOT EXISTS "idx_cnt_resources_type" ON "public"."cnt_resources" USING "btree" ("resource_type");



CREATE INDEX IF NOT EXISTS "idx_content_review_cycles_assigned_reviewer" ON "public"."wf_review_cycles" USING "btree" ("assigned_reviewer_id");



CREATE INDEX IF NOT EXISTS "idx_content_review_cycles_content_id" ON "public"."wf_review_cycles" USING "btree" ("content_id");



CREATE INDEX IF NOT EXISTS "idx_content_review_cycles_due_date" ON "public"."wf_review_cycles" USING "btree" ("due_date");



CREATE INDEX IF NOT EXISTS "idx_content_review_cycles_status" ON "public"."wf_review_cycles" USING "btree" ("status");



CREATE INDEX IF NOT EXISTS "idx_content_review_cycles_submitted_by" ON "public"."wf_review_cycles" USING "btree" ("submitted_by");



CREATE INDEX IF NOT EXISTS "idx_contents_author_id" ON "public"."cnt_contents" USING "btree" ("author_id");



CREATE INDEX IF NOT EXISTS "idx_contents_category" ON "public"."cnt_contents" USING "btree" ("category");



CREATE INDEX IF NOT EXISTS "idx_contents_content_type" ON "public"."cnt_contents" USING "btree" ("content_type");



CREATE INDEX IF NOT EXISTS "idx_contents_featured" ON "public"."cnt_contents" USING "btree" ("is_featured");



CREATE INDEX IF NOT EXISTS "idx_contents_organisation_id" ON "public"."cnt_contents" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_contents_published_at" ON "public"."cnt_contents" USING "btree" ("published_at");



CREATE INDEX IF NOT EXISTS "idx_contents_sector_id" ON "public"."cnt_contents" USING "btree" ("primary_sector_id");



CREATE UNIQUE INDEX IF NOT EXISTS "idx_contents_slug" ON "public"."cnt_contents" USING "btree" ("slug") WHERE ("slug" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_contents_status" ON "public"."cnt_contents" USING "btree" ("status");



CREATE INDEX IF NOT EXISTS "idx_contents_subtype" ON "public"."cnt_contents" USING "btree" ("content_subtype");



CREATE INDEX IF NOT EXISTS "idx_contents_type" ON "public"."cnt_contents" USING "btree" ("content_type");



CREATE INDEX IF NOT EXISTS "idx_dim_business_stages_code" ON "public"."dim_business_stages" USING "btree" ("stage_code");



CREATE INDEX IF NOT EXISTS "idx_dim_program_types_code" ON "public"."dim_program_types" USING "btree" ("type_code");



CREATE INDEX IF NOT EXISTS "idx_dim_sectors_code" ON "public"."dim_sectors" USING "btree" ("sector_code");



CREATE INDEX IF NOT EXISTS "idx_dim_sectors_parent" ON "public"."dim_sectors" USING "btree" ("parent_sector_id");



CREATE INDEX IF NOT EXISTS "idx_dim_support_categories_code" ON "public"."dim_support_categories" USING "btree" ("category_code");



CREATE INDEX IF NOT EXISTS "idx_dim_support_categories_parent" ON "public"."dim_support_categories" USING "btree" ("parent_category_id");



CREATE INDEX IF NOT EXISTS "idx_eco_business_directory_org_type" ON "public"."eco_business_directory" USING "btree" ("organization_type");



CREATE INDEX IF NOT EXISTS "idx_eco_business_directory_organisation_id" ON "public"."eco_business_directory" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_eco_business_directory_primary_sector" ON "public"."eco_business_directory" USING "btree" ("primary_sector_id");



CREATE INDEX IF NOT EXISTS "idx_eco_business_directory_slug" ON "public"."eco_business_directory" USING "btree" ("slug") WHERE ("slug" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_eco_business_directory_support_cat" ON "public"."eco_business_directory" USING "btree" ("primary_support_category_id");



CREATE INDEX IF NOT EXISTS "idx_eco_business_directory_tags" ON "public"."eco_business_directory" USING "gin" ("tags");



CREATE INDEX IF NOT EXISTS "idx_eco_growth_areas_organisation_id" ON "public"."eco_growth_areas" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_eco_programs_emirate" ON "public"."eco_programs" USING "btree" ("emirate_id");



CREATE INDEX IF NOT EXISTS "idx_eco_programs_org" ON "public"."eco_programs" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_eco_programs_type" ON "public"."eco_programs" USING "btree" ("program_type_id");



CREATE INDEX IF NOT EXISTS "idx_eco_zones_coordinates" ON "public"."eco_zones" USING "gist" ("coordinates");



CREATE INDEX IF NOT EXISTS "idx_eco_zones_location_type" ON "public"."eco_zones" USING "btree" ("location_type");



CREATE INDEX IF NOT EXISTS "idx_eco_zones_organisation_id" ON "public"."eco_zones" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_eco_zones_slug" ON "public"."eco_zones" USING "btree" ("slug") WHERE ("slug" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_eco_zones_tags" ON "public"."eco_zones" USING "gin" ("tags");



CREATE INDEX IF NOT EXISTS "idx_growth_areas_organisation_id" ON "public"."eco_growth_areas" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_media_assets_kind" ON "public"."media_assets" USING "btree" ("kind");



CREATE INDEX IF NOT EXISTS "idx_media_assets_public_url_not_null" ON "public"."media_assets" USING "btree" ("public_url") WHERE ("public_url" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_media_items_domain" ON "public"."media_items" USING "btree" ("domain") WHERE ("domain" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_media_items_format" ON "public"."media_items" USING "btree" ("format") WHERE ("format" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_media_items_popularity" ON "public"."media_items" USING "btree" ("popularity") WHERE ("popularity" IS NOT NULL);



CREATE INDEX IF NOT EXISTS "idx_media_items_pub_grid_keyset" ON "public"."media_items" USING "btree" ("published_at" DESC, "id" DESC) WHERE (("status" = 'Published'::"text") AND ("visibility" = 'Public'::"text") AND ("published_at" IS NOT NULL));



CREATE INDEX IF NOT EXISTS "idx_media_items_published_at" ON "public"."media_items" USING "btree" ("published_at" DESC);
...
CREATE INDEX IF NOT EXISTS "idx_media_taxonomies_taxonomy_id" ON "public"."media_taxonomies" USING "btree" ("taxonomy_id");



CREATE INDEX IF NOT EXISTS "idx_media_views_media_id" ON "public"."media_views" USING "btree" ("media_id");



CREATE INDEX IF NOT EXISTS "idx_media_views_viewed_at" ON "public"."media_views" USING "btree" ("viewed_at" DESC);



CREATE INDEX IF NOT EXISTS "idx_mktplc_investment_location" ON "public"."mktplc_investment_opportunities" USING "btree" ("location_id");



CREATE INDEX IF NOT EXISTS "idx_mktplc_investment_sector" ON "public"."mktplc_investment_opportunities" USING "btree" ("primary_sector_id");



CREATE INDEX IF NOT EXISTS "idx_mktplc_services_organisation_id" ON "public"."mktplc_services" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_prog_stages_program" ON "public"."jct_program_target_stages" USING "btree" ("program_id");



CREATE INDEX IF NOT EXISTS "idx_prog_stages_stage" ON "public"."jct_program_target_stages" USING "btree" ("stage_id");



CREATE INDEX IF NOT EXISTS "idx_prog_support_category" ON "public"."jct_program_support_categories" USING "btree" ("support_category_id");



CREATE INDEX IF NOT EXISTS "idx_prog_support_program" ON "public"."jct_program_support_categories" USING "btree" ("program_id");



CREATE INDEX IF NOT EXISTS "idx_review_approval_actions_action_by" ON "public"."wf_review_actions" USING "btree" ("action_by");



CREATE INDEX IF NOT EXISTS "idx_review_approval_actions_action_type" ON "public"."wf_review_actions" USING "btree" ("action_type");



CREATE INDEX IF NOT EXISTS "idx_review_approval_actions_content_id" ON "public"."wf_review_actions" USING "btree" ("content_id");



CREATE INDEX IF NOT EXISTS "idx_review_approval_actions_created_at" ON "public"."wf_review_actions" USING "btree" ("created_at");



CREATE INDEX IF NOT EXISTS "idx_review_approval_actions_review_cycle_id" ON "public"."wf_review_actions" USING "btree" ("review_cycle_id");



CREATE INDEX IF NOT EXISTS "idx_review_assignments_assigned_reviewer" ON "public"."wf_review_assignments" USING "btree" ("assigned_reviewer_id");



CREATE INDEX IF NOT EXISTS "idx_review_assignments_content_id" ON "public"."wf_review_assignments" USING "btree" ("content_id");



CREATE INDEX IF NOT EXISTS "idx_review_assignments_due_date" ON "public"."wf_review_assignments" USING "btree" ("due_date");



CREATE INDEX IF NOT EXISTS "idx_review_assignments_review_cycle_id" ON "public"."wf_review_assignments" USING "btree" ("review_cycle_id");



CREATE INDEX IF NOT EXISTS "idx_review_assignments_status" ON "public"."wf_review_assignments" USING "btree" ("status");



CREATE INDEX IF NOT EXISTS "idx_review_comments_author_id" ON "public"."wf_review_comments" USING "btree" ("author_id");



CREATE INDEX IF NOT EXISTS "idx_review_comments_comment_type" ON "public"."wf_review_comments" USING "btree" ("comment_type");



CREATE INDEX IF NOT EXISTS "idx_review_comments_content_id" ON "public"."wf_review_comments" USING "btree" ("content_id");



CREATE INDEX IF NOT EXISTS "idx_review_comments_created_at" ON "public"."wf_review_comments" USING "btree" ("created_at");



CREATE INDEX IF NOT EXISTS "idx_review_comments_review_cycle_id" ON "public"."wf_review_comments" USING "btree" ("review_cycle_id");



CREATE INDEX IF NOT EXISTS "idx_services_organisation_id" ON "public"."mktplc_services" USING "btree" ("organization_id");



CREATE INDEX IF NOT EXISTS "idx_services_partner_id" ON "public"."mktplc_services" USING "btree" ("partner_id");



CREATE INDEX IF NOT EXISTS "idx_services_status" ON "public"."mktplc_services" USING "btree" ("status");



CREATE INDEX IF NOT EXISTS "idx_services_submitted_on" ON "public"."mktplc_services" USING "btree" ("submitted_on");



CREATE INDEX IF NOT EXISTS "idx_services_type" ON "public"."mktplc_services" USING "btree" ("type");



CREATE INDEX IF NOT EXISTS "media_assets_media_id_idx" ON "public"."media_assets" USING "btree" ("media_id");



CREATE INDEX IF NOT EXISTS "idx_txn_tags_value" ON "public"."txn_tags" USING "btree" ("value");



CREATE INDEX IF NOT EXISTS "idx_txn_facets_code" ON "public"."txn_facets" USING "btree" ("code");



CREATE INDEX IF NOT EXISTS "idx_txn_facet_translations_base_id" ON "public"."txn_facet_translations" USING "btree" ("base_id");



CREATE INDEX IF NOT EXISTS "idx_txn_facet_translations_language_code" ON "public"."txn_facet_translations" USING "btree" ("language_code");



CREATE INDEX IF NOT EXISTS "idx_txn_facet_values_facet_id" ON "public"."txn_facet_values" USING "btree" ("facet_id");



CREATE INDEX IF NOT EXISTS "idx_txn_facet_values_code" ON "public"."txn_facet_values" USING "btree" ("code");



CREATE INDEX IF NOT EXISTS "idx_txn_facet_value_translations_base_id" ON "public"."txn_facet_value_translations" USING "btree" ("base_id");



CREATE INDEX IF NOT EXISTS "idx_txn_facet_value_translations_language_code" ON "public"."txn_facet_value_translations" USING "btree" ("language_code");



CREATE INDEX IF NOT EXISTS "idx_txn_collections_parent_id" ON "public"."txn_collections" USING "btree" ("parent_id");



CREATE INDEX IF NOT EXISTS "idx_txn_collections_position" ON "public"."txn_collections" USING "btree" ("position");



CREATE INDEX IF NOT EXISTS "idx_txn_collection_translations_base_id" ON "public"."txn_collection_translations" USING "btree" ("base_id");



CREATE INDEX IF NOT EXISTS "idx_txn_collection_translations_language_code" ON "public"."txn_collection_translations" USING "btree" ("language_code");



CREATE INDEX IF NOT EXISTS "idx_txn_collection_translations_slug" ON "public"."txn_collection_translations" USING "btree" ("slug");



CREATE UNIQUE INDEX IF NOT EXISTS "uq_taxonomies_kind_key" ON "public"."taxonomies" USING "btree" ("kind", "key");
...
CREATE OR REPLACE TRIGGER "update_business_directory_updated_at" BEFORE UPDATE ON "public"."eco_business_directory" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_content_review_cycles_updated_at" BEFORE UPDATE ON "public"."wf_review_cycles" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_contents_updated_at" BEFORE UPDATE ON "public"."cnt_contents" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_growth_areas_updated_at" BEFORE UPDATE ON "public"."eco_growth_areas" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_review_assignments_updated_at" BEFORE UPDATE ON "public"."wf_review_assignments" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_review_comments_updated_at" BEFORE UPDATE ON "public"."wf_review_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_review_workflow_templates_updated_at" BEFORE UPDATE ON "public"."wf_review_templates" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_services_updated_at" BEFORE UPDATE ON "public"."mktplc_services" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_zones_updated_at" BEFORE UPDATE ON "public"."eco_zones" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."txn_facet_translations"
    ADD CONSTRAINT "txn_facet_translations_base_id_fkey" FOREIGN KEY ("base_id") REFERENCES "public"."txn_facets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."txn_facet_values"
    ADD CONSTRAINT "txn_facet_values_facet_id_fkey" FOREIGN KEY ("facet_id") REFERENCES "public"."txn_facets"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."txn_facet_value_translations"
    ADD CONSTRAINT "txn_facet_value_translations_base_id_fkey" FOREIGN KEY ("base_id") REFERENCES "public"."txn_facet_values"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."txn_collections"
    ADD CONSTRAINT "txn_collections_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."txn_collections"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."txn_collection_translations"
    ADD CONSTRAINT "txn_collection_translations_base_id_fkey" FOREIGN KEY ("base_id") REFERENCES "public"."txn_collections"("id") ON DELETE CASCADE;
...
CREATE POLICY "business_directory_select_policy" ON "public"."eco_business_directory" USING (("organization_id" = "public"."get_org_id_from_claim"())) WITH CHECK (("organization_id" = "public"."get_org_id_from_claim"()));



CREATE POLICY "business_directory_update_policy" ON "public"."eco_business_directory" USING (("organization_id" = "public"."get_org_id_from_claim"())) WITH CHECK (("organization_id" = "public"."get_org_id_from_claim"()));
...
CREATE POLICY "org_write" ON "public"."eco_business_directory" USING (("organization_id" = "public"."get_org_id_from_claim"())) WITH CHECK (("organization_id" = "public"."get_org_id_from_claim"()));
...
GRANT ALL ON FUNCTION "public"."_is_authenticated"() TO "anon";
GRANT ALL ON FUNCTION "public"."_is_authenticated"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."_is_authenticated"() TO "service_role";



GRANT ALL ON FUNCTION "public"."_is_public_published"("_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."_is_public_published"("_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."_is_public_published"("_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."_jtxt"("j" "jsonb", "key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."_jtxt"("j" "jsonb", "key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."_jtxt"("j" "jsonb", "key" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."can_access_organisation"("org_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_organisation"("org_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_organisation"("org_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_media_item"("_base" "jsonb", "_type" "text", "_child" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."create_media_item"("_base" "jsonb", "_type" "text", "_child" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_media_item"("_base" "jsonb", "_type" "text", "_child" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."current_org_id_from_name"() TO "anon";
GRANT ALL ON FUNCTION "public"."current_org_id_from_name"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."current_org_id_from_name"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."effective_org_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."effective_org_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."effective_org_id"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."enforce_slug_normalization"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_slug_normalization"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_slug_normalization"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_app_customer_type"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_app_customer_type"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_app_customer_type"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_app_organization_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_app_organization_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_app_organization_id"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_claim_org_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_claim_org_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_claim_org_id"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_claim_org_name"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_claim_org_name"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_claim_org_name"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_current_customer_type"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_current_customer_type"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_current_customer_type"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_current_organisation_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_current_organisation_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_current_organisation_id"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_current_user_organisation"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_current_user_organisation"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_current_user_organisation"() TO "service_role";
...
GRANT ALL ON TABLE "public"."media_taxonomies" TO "anon";
GRANT ALL ON TABLE "public"."media_taxonomies" TO "authenticated";
GRANT ALL ON TABLE "public"."media_taxonomies" TO "service_role";
...
GRANT ALL ON TABLE "public"."v_media_all" TO "anon";
GRANT ALL ON TABLE "public"."v_media_all" TO "authenticated";
GRANT ALL ON TABLE "public"."v_media_all" TO "service_role";



GRANT ALL ON FUNCTION "public"."get_media_item_full"("media_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_media_item_full"("media_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_media_item_full"("media_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_org_id_from_claim"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_org_id_from_claim"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_org_id_from_claim"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."increment_flag_count"("content_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."increment_flag_count"("content_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."increment_flag_count"("content_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_enterprise_user"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_enterprise_user"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_enterprise_user"() TO "service_role";



GRANT ALL ON FUNCTION "public"."is_member_of_claim_org"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_member_of_claim_org"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_member_of_claim_org"() TO "service_role";



GRANT ALL ON FUNCTION "public"."is_partner_user"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_partner_user"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_partner_user"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_staff_with_allowed_org"() TO "anon";
GRANT ALL ON FUNCTION "public"."is_staff_with_allowed_org"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_staff_with_allowed_org"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."log_activity"("p_entity_type" "text", "p_entity_id" "uuid", "p_action" "text", "p_details" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."log_activity"("p_entity_type" "text", "p_entity_id" "uuid", "p_action" "text", "p_details" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_activity"("p_entity_type" "text", "p_entity_id" "uuid", "p_action" "text", "p_details" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."normalize_slug"("input" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."normalize_slug"("input" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."normalize_slug"("input" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_current_user_context"("user_id" "text", "customer_type" "text", "user_role" "text", "organisation_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."set_current_user_context"("user_id" "text", "customer_type" "text", "user_role" "text", "organisation_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_current_user_context"("user_id" "text", "customer_type" "text", "user_role" "text", "organisation_name" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."set_org_and_creator"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_org_and_creator"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_org_and_creator"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."test_rls_visibility"() TO "anon";
GRANT ALL ON FUNCTION "public"."test_rls_visibility"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."test_rls_visibility"() TO "service_role";



GRANT ALL ON FUNCTION "public"."test_rls_visibility"("org_claim" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."test_rls_visibility"("org_claim" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."test_rls_visibility"("org_claim" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_media_item"("_id" "uuid", "_base" "jsonb", "_type" "text", "_child" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."update_media_item"("_id" "uuid", "_base" "jsonb", "_type" "text", "_child" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_media_item"("_id" "uuid", "_base" "jsonb", "_type" "text", "_child" "jsonb") TO "service_role";
...
GRANT ALL ON TABLE "public"."auth_organization_members" TO "anon";
GRANT ALL ON TABLE "public"."auth_organization_members" TO "authenticated";
GRANT ALL ON TABLE "public"."auth_organization_members" TO "service_role";



GRANT ALL ON TABLE "public"."auth_organizations" TO "anon";
GRANT ALL ON TABLE "public"."auth_organizations" TO "authenticated";
GRANT ALL ON TABLE "public"."auth_organizations" TO "service_role";



GRANT ALL ON TABLE "public"."auth_user_profiles" TO "anon";
GRANT ALL ON TABLE "public"."auth_user_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."auth_user_profiles" TO "service_role";
...
GRANT ALL ON TABLE "public"."cnt_contents" TO "anon";
GRANT ALL ON TABLE "public"."cnt_contents" TO "authenticated";
GRANT ALL ON TABLE "public"."cnt_contents" TO "service_role";



GRANT ALL ON TABLE "public"."cnt_events" TO "anon";
GRANT ALL ON TABLE "public"."cnt_events" TO "authenticated";
GRANT ALL ON TABLE "public"."cnt_events" TO "service_role";



GRANT ALL ON TABLE "public"."cnt_experiences" TO "anon";
GRANT ALL ON TABLE "public"."cnt_experiences" TO "authenticated";
GRANT ALL ON TABLE "public"."cnt_experiences" TO "service_role";



GRANT ALL ON TABLE "public"."cnt_metrics" TO "anon";
GRANT ALL ON TABLE "public"."cnt_metrics" TO "authenticated";
GRANT ALL ON TABLE "public"."cnt_metrics" TO "service_role";



GRANT ALL ON TABLE "public"."cnt_resources" TO "anon";
GRANT ALL ON TABLE "public"."cnt_resources" TO "authenticated";
GRANT ALL ON TABLE "public"."cnt_resources" TO "service_role";



GRANT ALL ON TABLE "public"."comm_mentors" TO "anon";
GRANT ALL ON TABLE "public"."comm_mentors" TO "authenticated";
GRANT ALL ON TABLE "public"."comm_mentors" TO "service_role";



GRANT ALL ON TABLE "public"."wf_review_actions" TO "anon";
GRANT ALL ON TABLE "public"."wf_review_actions" TO "authenticated";
GRANT ALL ON TABLE "public"."wf_review_actions" TO "service_role";



GRANT ALL ON TABLE "public"."wf_review_comments" TO "anon";
GRANT ALL ON TABLE "public"."wf_review_comments" TO "authenticated";
GRANT ALL ON TABLE "public"."wf_review_comments" TO "service_role";



GRANT ALL ON TABLE "public"."wf_review_cycles" TO "anon";
GRANT ALL ON TABLE "public"."wf_review_cycles" TO "authenticated";
GRANT ALL ON TABLE "public"."wf_review_cycles" TO "service_role";



GRANT ALL ON TABLE "public"."content_review_status" TO "anon";
GRANT ALL ON TABLE "public"."content_review_status" TO "authenticated";
GRANT ALL ON TABLE "public"."content_review_status" TO "service_role";



GRANT ALL ON TABLE "public"."dim_business_stages" TO "anon";
GRANT ALL ON TABLE "public"."dim_business_stages" TO "authenticated";
GRANT ALL ON TABLE "public"."dim_business_stages" TO "service_role";



GRANT ALL ON TABLE "public"."dim_program_types" TO "anon";
GRANT ALL ON TABLE "public"."dim_program_types" TO "authenticated";
GRANT ALL ON TABLE "public"."dim_program_types" TO "service_role";



GRANT ALL ON TABLE "public"."dim_sectors" TO "anon";
GRANT ALL ON TABLE "public"."dim_sectors" TO "authenticated";
GRANT ALL ON TABLE "public"."dim_sectors" TO "service_role";



GRANT ALL ON TABLE "public"."dim_support_categories" TO "anon";
GRANT ALL ON TABLE "public"."dim_support_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."dim_support_categories" TO "service_role";



GRANT ALL ON TABLE "public"."eco_business_directory" TO "anon";
GRANT ALL ON TABLE "public"."eco_business_directory" TO "authenticated";
GRANT ALL ON TABLE "public"."eco_business_directory" TO "service_role";



GRANT ALL ON TABLE "public"."eco_growth_areas" TO "anon";
GRANT ALL ON TABLE "public"."eco_growth_areas" TO "authenticated";
GRANT ALL ON TABLE "public"."eco_growth_areas" TO "service_role";



GRANT ALL ON TABLE "public"."eco_programs" TO "anon";
GRANT ALL ON TABLE "public"."eco_programs" TO "authenticated";
GRANT ALL ON TABLE "public"."eco_programs" TO "service_role";



GRANT ALL ON TABLE "public"."eco_zones" TO "anon";
GRANT ALL ON TABLE "public"."eco_zones" TO "authenticated";
GRANT ALL ON TABLE "public"."eco_zones" TO "service_role";



GRANT ALL ON TABLE "public"."geo_emirates" TO "anon";
GRANT ALL ON TABLE "public"."geo_emirates" TO "authenticated";
GRANT ALL ON TABLE "public"."geo_emirates" TO "service_role";



GRANT ALL ON TABLE "public"."jct_business_sectors" TO "anon";
GRANT ALL ON TABLE "public"."jct_business_sectors" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_business_sectors" TO "service_role";



GRANT ALL ON TABLE "public"."jct_business_support_categories" TO "anon";
GRANT ALL ON TABLE "public"."jct_business_support_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_business_support_categories" TO "service_role";



GRANT ALL ON TABLE "public"."jct_content_sectors" TO "anon";
GRANT ALL ON TABLE "public"."jct_content_sectors" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_content_sectors" TO "service_role";



GRANT ALL ON TABLE "public"."jct_event_sectors" TO "anon";
GRANT ALL ON TABLE "public"."jct_event_sectors" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_event_sectors" TO "service_role";



GRANT ALL ON TABLE "public"."jct_event_support_categories" TO "anon";
GRANT ALL ON TABLE "public"."jct_event_support_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_event_support_categories" TO "service_role";



GRANT ALL ON TABLE "public"."jct_investment_sectors" TO "anon";
GRANT ALL ON TABLE "public"."jct_investment_sectors" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_investment_sectors" TO "service_role";



GRANT ALL ON TABLE "public"."jct_program_support_categories" TO "anon";
GRANT ALL ON TABLE "public"."jct_program_support_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_program_support_categories" TO "service_role";



GRANT ALL ON TABLE "public"."jct_program_target_stages" TO "anon";
GRANT ALL ON TABLE "public"."jct_program_target_stages" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_program_target_stages" TO "service_role";



GRANT ALL ON TABLE "public"."jct_resource_sectors" TO "anon";
GRANT ALL ON TABLE "public"."jct_resource_sectors" TO "authenticated";
GRANT ALL ON TABLE "public"."jct_resource_sectors" TO "service_role";
...
GRANT ALL ON TABLE "public"."media_views" TO "anon";
GRANT ALL ON TABLE "public"."media_views" TO "authenticated";
GRANT ALL ON TABLE "public"."media_views" TO "service_role";



GRANT ALL ON TABLE "public"."mktplc_investment_opportunities" TO "anon";
GRANT ALL ON TABLE "public"."mktplc_investment_opportunities" TO "authenticated";
GRANT ALL ON TABLE "public"."mktplc_investment_opportunities" TO "service_role";



GRANT ALL ON TABLE "public"."mktplc_services" TO "anon";
GRANT ALL ON TABLE "public"."mktplc_services" TO "authenticated";
GRANT ALL ON TABLE "public"."mktplc_services" TO "service_role";



GRANT ALL ON TABLE "public"."v_cnt_active_events" TO "anon";
GRANT ALL ON TABLE "public"."v_cnt_active_events" TO "authenticated";
GRANT ALL ON TABLE "public"."v_cnt_active_events" TO "service_role";



GRANT ALL ON TABLE "public"."v_cnt_metrics_latest" TO "anon";
GRANT ALL ON TABLE "public"."v_cnt_metrics_latest" TO "authenticated";
GRANT ALL ON TABLE "public"."v_cnt_metrics_latest" TO "service_role";



GRANT ALL ON TABLE "public"."v_media_public" TO "anon";
GRANT ALL ON TABLE "public"."v_media_public" TO "authenticated";
GRANT ALL ON TABLE "public"."v_media_public" TO "service_role";



GRANT ALL ON TABLE "public"."v_media_public_grid" TO "anon";
GRANT ALL ON TABLE "public"."v_media_public_grid" TO "authenticated";
GRANT ALL ON TABLE "public"."v_media_public_grid" TO "service_role";



GRANT ALL ON TABLE "public"."wf_review_assignments" TO "anon";
GRANT ALL ON TABLE "public"."wf_review_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."wf_review_assignments" TO "service_role";



GRANT ALL ON TABLE "public"."wf_review_templates" TO "anon";
GRANT ALL ON TABLE "public"."wf_review_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."wf_review_templates" TO "service_role";
